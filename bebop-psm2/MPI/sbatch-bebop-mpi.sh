...
/usr/bin/time -v -o time_hello1.txt mpiexec -n 38 -ppn 1 -hosts bdw-0387,bdw-0390 /blues/gpfs/home/tshu/project/bebop/MPI_in_MPI/bebop-psm2/MPI/hello.x &
/usr/bin/time -v -o time_hello2.txt mpiexec -n 34 -ppn 1 -hosts bdw-0387,bdw-0390 /blues/gpfs/home/tshu/project/bebop/MPI_in_MPI/bebop-psm2/MPI/hello.x
