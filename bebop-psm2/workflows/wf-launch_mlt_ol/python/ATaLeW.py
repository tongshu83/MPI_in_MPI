...
def run():
    ...
    try:
        ...
        in_pool_df = data.gen_lv_in_smpl(num_init * 100)
        ...
        in_df = cm.measure_perf(in_conf_df, cm.app_in_name(app_name))
	...
	if (factor > 1):
            ...
            new_in_df = cm.measure_perf(new_in_conf_df, cm.app_in_name(app_name))
