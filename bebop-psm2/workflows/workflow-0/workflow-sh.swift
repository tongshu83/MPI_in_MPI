...
main()
{
	...
	int procs[] = [2, 2];
	string cmds[];
	cmds[0] = "/blues/gpfs/home/tshu/project/bebop/MPI_in_MPI/bebop-psm2/scripts/script1.sh";
	cmds[1] = "/blues/gpfs/home/tshu/project/bebop/MPI_in_MPI/bebop-psm2/scripts/script2.sh";
