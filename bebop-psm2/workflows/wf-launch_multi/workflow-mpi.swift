...
main()
{
	...
	envs[0] = [ "OMP_NUM_THREADS=2", "swift_chdir="+dir, "swift_output="+dir/"output_hello1.txt", "swift_exectime="+dir/"time_hello1.txt" ];
	envs[1] = [ "OMP_NUM_THREADS=3", "swift_chdir="+dir, "swift_output="+dir/"output_hello2.txt", "swift_exectime="+dir/"time_hello2.txt" ];
